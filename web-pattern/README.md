# Deploy a sample Java App on Liberty Profile backed by a highly available MongoDB installation on Ubuntu and CentOS virtual machines

<a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fjarekmisz%2Fazure-scripts%2Fmaster%2Fweb-pattern%2Fazuredeploy.json" target="_blank">
    <img src="http://azuredeploy.net/deploybutton.png"/>
</a>

This template creates a multi-server deployment on Ubuntu and CentOS virtual machines. It configures the MongoDB installation for high availability using a replica set.
It ideploys WAS Liberty Profile Application Server and and mongoDBSample application that uses MongoDB for persistency. 
